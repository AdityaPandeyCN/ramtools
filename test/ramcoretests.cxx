...
TEST_F(ramcoreTest, ConversionProducesExpectedEntries)
{
   ...
   samtoramntuple(samFile, rntupleFile, 505, 0);
...
{
   const char *rntupleFile = "test_rntuple.root";
   samtoramntuple("samexample.sam", rntupleFile, 505, 0);
...
TEST_F(ramcoreTest, RNTupleViewCigarOverlap)
{
   ...
   samtoramntuple(customSam, rntupleFile, 505, 0);
...
TEST_F(ramcoreTest, ConstructingARecordKeepsTheOpenFileState)
{
   ...
   testing::internal::CaptureStderr();
   samtoramntuple(unsortedSam, unsortedFile, 505, 0);
   ...
   samtoramntuple(sortedSam, sortedFile, 505, 0);
